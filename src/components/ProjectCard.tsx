...
import { SiCss3, SiGithub, SiGo, SiHtml5, SiJavascript, SiNextdotjs, SiNodedotjs, SiPython, SiReact, SiSass, SiTypescript } from 'react-icons/si';
...
const ProjectCard: React.FC<ProjectCardProps> = ({
  name, description, language, githubLink, liveLink, stars, forks
}) => (
  <div
    className="flex h-full min-h-[8rem] cursor-pointer flex-col rounded-md border-2 p-4 hover:shadow dark:border-gray-800 dark:hover:border-gray-600"
  >
