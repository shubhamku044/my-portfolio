    ...
    <div className="space-y-10">
      <div className="space-y-4">
        ...
        <p className={styles.desc}>
          Building web applications is something I enjoy doing every day, from
          the server side to the client side. I always enjoy taking on
          programming challenges and learning new technologies. Currently,
          I&apos;m working as a Software Engineer Intern at{" "}
          <Link
            className="font-semibold text-blue-500 underline dark:text-blue-400"
            href="https://www.sharefable.com/"
            target="_blank"
            rel="noreferrer"
          >
            Fable
          ...
          <br />
          <br />
          ReactJs, NextJs, TypeScript, and Node.js are my go-to tools for
          building web applications. I&apos;m also a fan of Go and Python.
        </p>
      </div>
      <div className="space-y-4">
        <h4 className={styles.subHeading}>Technologies 💻</h4>
        <p className={styles.desc}>
          I use a wide range of tools and technologies to improve the quality of
          my code and projects, as well as my development workflow. The
          languages and technologies listed below are those that I am actively
          working with in my present work and have mastered through previous
          experience.
        </p>
      ...
      <div className="space-y-4">
        ...
        <p className={styles.desc}>
          I take pleasure in crafting open-source projects on GitHub, both as a
          means of continuous learning and a platform for sharing my expertise.
          Here, I present a selection of my most well-received repositories.
        </p>
        <Projects />
      </div>
      <div className="space-y-4">
